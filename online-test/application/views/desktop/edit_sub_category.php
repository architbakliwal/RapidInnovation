...
if($resultstatus){ echo "<div class='alert alert-success'>".$resultstatus."</div>"; }
 ?> 
<form method="post" action="<?php echo site_url('sub_category_controller/update_category/'.$cid);?>">
<a href="<?php echo site_url('sub_category_controller');?>"  class="btn btn-danger">Back</a>
