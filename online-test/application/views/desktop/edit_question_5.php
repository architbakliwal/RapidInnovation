                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form method="post" action="<?php echo site_url('qbank/edit_question/'.$result['0']['qid'].'/5');?>">
...
?>
<tr><td valign="top" style="height:30px;"><?php echo $okey+1;?>) &nbsp;&nbsp;</td><td valign="top">
<input type="hidden" value="<?php echo $option_value['oid'];?>" name="oids[]">
<input type="text" name="option[]" value="<?php echo $option_value['option_value'];?>">Ex: option<?php echo $okey+1; ?>=Answer<?php echo $okey+1; ?>  </td></tr>
...
?>
<tr><td valign="top"><?php echo $op.")"; ?> &nbsp;&nbsp; </td><td valign="top"><input type="text" name="option[]">Ex: option<?php echo $op; ?>=Answer<?php echo $op; ?> </td></tr>
<?php
$op++;
}
}
