                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form method="post" action="<?php echo site_url('qbank/add_new_mul');?>">
...
<textarea name="option[]"></textarea> </td></tr>
<tr><td valign="top">3) &nbsp;&nbsp; <input id="CheckBox[]" type="checkbox"  name="CheckBox[]" value="2" /></td><td valign="top">
<textarea name="option[]"></textarea> </td></tr>
<tr><td valign="top">4)  &nbsp;&nbsp; <input id="CheckBox[]" type="checkbox"  name="CheckBox[]" value="3"  /><?php $op="5"; ?></td><td valign="top">
<textarea name="option[]"></textarea> </td></tr>
<?php
