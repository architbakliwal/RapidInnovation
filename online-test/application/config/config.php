...
/*
| webcam plugin tru for enable and false for disable
| This feature is under testing version, We are not responsible if it does not work with any devices or browsers.
| This plugin is developed by using WebcamJS v1.0 javascript library.
| Before enabling this plugin read user license and permissions carefully at below link. 
...
// Define API key in alphanumeric value. API helps you to register user or fetch other data from another application. to know more visit documentation available at our website http://savsoftquiz.com 
// If you don't want to use API key then leave it empty. Don't share API key with anyone. 
$config['savsoft_api_key']="123";
...
/*
| ignore it, its for future release
| GCM - Google cloud messaging service
| API KEY for GCM
| only require if you integrated it with Savsoft Quiz Android APP
*/
$config['gcm_key']="";
